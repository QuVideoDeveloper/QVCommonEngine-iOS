...
#define QVET_ENGINE_VERSION				0x00050009		//QVET_ENGINE_VERSION是对模板解析处理引擎的版本标示，如果模板版本>模板引擎版本，则判定为不支持
...
#define QVTP_FILE_ID_SCENE_CFG_FILE			105	 //默认是105
#define QVTP_FILE_ID_SCENE_CFG_FILE_W4_H3	QVTP_FILE_ID_SCENE_CFG_FILE
#define QVTP_FILE_ID_SCENE_CFG_FILE_W3_H4	107  //106已经被用掉了
#define QVTP_FILE_ID_SCENE_CFG_FILE_W9_H16  108
#define QVTP_FILE_ID_SCENE_CFG_FILE_W16_H9  109
#define QVTP_FILE_ID_SCENE_CFG_FILE_W1_H1   110
#define QVTP_FILE_ID_SCENE_CFG_FILE_W9_H18  111
#define QVTP_FILE_ID_SCENE_CFG_FILE_W18_H9  112
#define QVTP_FILE_ID_SCENE_CFG_FILE_W2_H3   113
#define QVTP_FILE_ID_SCENE_CFG_FILE_W3_H2   114		
#define QVTP_FILE_ID_SCENE_CFG_FILE_W6_H7   115
#define QVTP_FILE_ID_SCENE_CFG_FILE_W7_H6   116
...
//这个ID文件会告诉引擎素材需要引擎具备什么样能力
#define QVTP_FILE_ID_MATERIAL           	700
